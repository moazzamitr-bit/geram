...
export function serializeQuote(quote: Quote) {
  return {
    ...
    requestedIrr: quote.requestedIrr == null ? null : quote.requestedIrr.toString(),
    requestedWeightUg: quote.requestedWeightUg == null ? null : quote.requestedWeightUg.toString(),
